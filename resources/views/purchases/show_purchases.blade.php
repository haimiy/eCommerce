...
@section('title' , 'Show Purchases | Page')
@section('css')
    <!-- Icons CSS -->
...
<main role="main" class="main-content">
    <div class="container-fluid">
      <div class="row justify-content-center">
        <div class="col-12">
          <a href="/vendor/create_purchases" class="btn btn-primary mb-2"><span class="fe fe-edit fe-16 mr-1"></span> Add Purchases</a>
          <h5 class="card-text text-center">List Of All Purchases</h5>
          <div class="row my-4">
            <!-- Small table -->
            <div class="col-md-12">
                  ...
                  <table class="table datatables" id="dataTable-1">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{ $purchase->total_cost_price }}</td>
