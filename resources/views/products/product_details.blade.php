@extends('layouts.app')
@section('title', 'View Products | Page')
@section('css')
        ...
        <div class="product-details-top">
                ...
                <div class="container">
                    <div class="product-gallery-carousel owl-carousel owl-full owl-nav-dark">
                       ...
                       <figure class="product-gallery-image">
                        <img src="{{ asset('images/products/' . $image->product_images) }}" data-zoom-image="{{  asset('assets/images/products/single/gallery/1-big.jpg') }}" alt="product image">
            ...
            <div class="product-details product-details-centered product-details-separator">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h1 class="product-title">{{ $products->product_name }}</h1><!-- End .product-title -->
                            ...
                            <div class="details-filter-row details-row-size">
                                ...
                                <div class="product-nav product-nav-dots">
                                    ...
                                    <a href="#" class="active" style="background: {{ $color->color }};"><span class="sr-only">{{ $color->colorname }}</span></a>
                                    @endforeach
                                </div><!-- End .product-nav -->
                            ...
                            <div class="details-filter-row details-row-size mb-md-1">
                                ...
                                <div class="product-size">
                                    ...
                                    <a href="#" title="{{ $size->sizename }}">{{ $size->size }}</a>
                                    @endforeach
