...
<main role="main" class="main-content">
    <div class="container-fluid">
      <div class="row justify-content-center">
        <div class="col-12">
          <a href="/vendor/create_product" class="btn btn-primary mb-2"><span class="fe fe-edit fe-16 mr-1"></span> Add Products</a>
          <h5 class="card-text text-center">List Of All Products</h5>
          <div class="row my-4">
            <!-- Small table -->
            <div class="col-md-12">
